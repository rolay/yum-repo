...
RUN yum install createrepo -y && \
    ...
    yum -y install --downloadonly --downloaddir=/rpms/k8s/kylinv10-sp3 podman cri-o container-selinux policycoreutils-python-utils python3-policycoreutils python3-libsemanage && \
