...
RUN mkdir -p /rpms/k8s/centos9 && \
    ...
    yum -y install --downloadonly --downloaddir=/rpms/k8s/kylinv10-sp3 podman cri-o runc container-selinux policycoreutils-python-utils python3-policycoreutils python3-libsemanage && \
